...
features:
  enable: true
  feature_item:
  - content: UQAM & Concordia University<br>(2017 - current)<br>ph.pereirabraga@gmail.com
...
mission_vision:
  enable: true
  tabs:
  - content: The QCBS R Workshop Series was founded by QCBS students Vincent Fugère, Dalal Hanna, and Zofia Taranu in 2014, inspired by the [McGill BGSA stats workshops](https://sites.google.com/site/mcgillbgsa/). The 10 workshops that are still offered today were first developed by QCBS students and postdoctoral fellows, and have been developed by many other QCBS students and postdoctoral fellows since 2014. In 2017, Léa Blondel, Marie-Hélène Brice and Pedro Henrique P. Braga began the conversion of the original Prezi presentations into RMarkdown, and the transition to hosting and developing content on GitHub.
